...
if ! (unalias rg 2>/dev/null; command -v rg) >/dev/null 2>&1; then
  ...
  [[ -x $_cc_bin ]] || _cc_bin=/Users/phoebej/.local/bin/claude
...
export PATH=/Users/phoebej/.nvm/versions/node/v26.1.0/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/opt/homebrew/bin:/Users/phoebej/.nvm/current/bin:/Users/phoebej/.local/bin:/Users/phoebej/.cargo/bin
